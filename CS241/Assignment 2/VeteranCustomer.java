...
/**
 * This class is a type of Customer. It contains the 4th highest priority.
 * @author Michael
 *
 */
public class VeteranCustomer extends Customer {
/**
 ...
 */
	public VeteranCustomer(String name, int priority, int id) {
